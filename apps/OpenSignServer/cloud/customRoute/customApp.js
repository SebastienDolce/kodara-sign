...
import { notifyProposalFirstView } from './proposalViewNotifications.js';
...
app.post('/htmltemplatetopdf', htmltemplatetopdf);
...
app.get('/proposal-public/:token', notifyProposalFirstView, getPublicProposal);
